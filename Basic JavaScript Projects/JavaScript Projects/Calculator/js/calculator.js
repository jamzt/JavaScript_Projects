...
const Calculator = {
    ...
    Display_Value: '0',
    // this will hold the first operand for any expressions , we set in to null for now
    First_Operand: null,
    // this will check wether or not the 2nd operand has been inputted by user
    Wait_Second_Operand: false,
    // this will hold the operator, we sert it to null for now
    operator: null,
};
...
function Input_Digit(digit) {
    ...
    // this checks if the wait_sec_operand is true and sets display_value
    //to the keyu that was clicked on
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        // we are saying that if the Display_Value doesn't contain a deciaml point
        // we want to add a decicmal point
